...
class displayFarbTestBl(BaseTest):
    """
    def execute(self):
    ...
    def run_test(self):
        ...
        testResult = self.serial_comm.send_and_receive("121")
    ...
    def build_content_box(self, parent):
        ...
        Gruen = Picture(box, image="./Bilder/Blau.PNG", align="top", height= 250, width= 250)
    ...
    def run_test(self):
        ...
        print(f"Antwort auf '121': {testResult}")
        # Falls du automatisch auswerten willst:
        # if testResult:
    ...
    def build_content_box(self, parent):
        ...
        Picture(box, image="./Bilder/Blau.PNG", align="top", height=250, width=250)
