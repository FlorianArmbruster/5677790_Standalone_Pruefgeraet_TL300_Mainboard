...
class displayFarbTestGn(BaseTest):
    """
    def execute(self):
    ...
    def run_test(self):
        ...
        testResult = self.serial_comm.send_and_receive("120")
    ...
    def build_content_box(self, parent):
        ...
        Gruen = Picture(box, image="./Bilder/Gruen.PNG", align="top", height= 250, width= 250)
    ...
    def run_test(self):
        ...
        # Optional: Ergebnis auswerten oder anzeigen
        #print(f"Antwort auf '120': {testResult}")

        # Du kannst hier auch automatisch auswerten, wenn du willst:
        # if testResult:
    ...
    def build_content_box(self, parent):
        ...
        Picture(box, image="./Bilder/Gruen.PNG", align="top", height=250, width=250)
